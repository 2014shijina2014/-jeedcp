 ...
 */
package com.jeedcp.modules.gen.util;
...
import com.jeedcp.common.utils.FileUtils;
import com.jeedcp.common.utils.FreeMarkers;
...
//		}
	...
	public static Map<String, Object> getDataModel(GenScheme genScheme){
		...
		model.put("functionAuthor", StringUtils.isNotBlank(genScheme.getFunctionAuthor())?genScheme.getFunctionAuthor(): CurrentUserUtils.getUser().getName());
