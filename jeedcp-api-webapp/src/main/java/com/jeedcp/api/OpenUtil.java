...
import com.jeedcp.api.annotation.ParamIgnore;
...
public class OpenUtil {
	 ...
	 * @throws IOException
	 */
	public static String buildSign(Map<String, String> paramsMap, String secret)
			throws IOException {
	...
	public static void main(String[] args) {
		try {
			System.out
					.println(sha1("123456appIdtesttimestamp330523156522123456"));
		} catch (IOException e) {
