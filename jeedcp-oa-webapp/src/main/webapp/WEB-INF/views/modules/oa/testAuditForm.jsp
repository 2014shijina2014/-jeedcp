    ...
    <fieldset>
        ...
        <table class="table-form">
            ...
            <tr>
                ...
                <td colspan="5">
                    <form:textarea path="content" class="form-control required" rows="5" maxlength="200" cssStyle="width:500px"/>
                </td>
            </tr>
            <tr>
                <td class="tit" rowspan="3">调整原因</td>
                <td class="tit">薪酬档级</td>
                <td><form:input path="olda" htmlEscape="false" maxlength="50" cssClass="form-control"/></td>
                <td class="tit" rowspan="3">拟调整标准</td>
                <td class="tit">薪酬档级</td>
                <td><form:input path="newa" htmlEscape="false" maxlength="50" cssClass="form-control"/></td>
            </tr>
            <tr>
                <td class="tit">月工资额</td>
                <td><form:input path="oldb" htmlEscape="false" maxlength="50" cssClass="form-control"/></td>
                <td class="tit">月工资额</td>
                <td><form:input path="newb" htmlEscape="false" maxlength="50" cssClass="form-control"/></td>
            </tr>
            <tr>
            ...
            <tr>
                <td class="tit">月增资</td>
                <td colspan="2"><form:input cssClass="form-control" path="addNum" htmlEscape="false" maxlength="50"/></td>
                <td class="tit">执行时间</td>
                <td colspan="2"><form:input cssClass="form-control" path="exeDate" htmlEscape="false" maxlength="50"/></td>
            </tr>
            <tr>
