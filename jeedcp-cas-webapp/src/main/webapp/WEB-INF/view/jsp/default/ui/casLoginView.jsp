...
<div class="box" id="login">
    <form:form method="post" id="fm1" commandName="${commandName}" htmlEscape="true">
        ...
        <section class="row">
            ...
            <%--<spring:message code="screen.welcome.label.captcha.captchaHolder" var="captchaHolder"/>--%>
            <form:input cssClass="required" cssErrorClass="error" id="captcha" size="25" tabindex="2.5" path="captcha"
                        placeholder="${captchaHolder }" accesskey="${captchaAccessKey}" autocomplete="off"
                        htmlEscape="true"/>
            <img alt="${captchaHolder }" src="captcha.jpg" onclick="this.src='captcha.jpg?'+Math.random();" style="padding-top: 10px">
        </section>

        <section class="row">
            <input type="checkbox" name="rememberMe" id="rememberMe" value="true" tabindex="3"/>
            <label for="rememberMe" style="display:inline"><spring:message code="screen.welcome.label.rememberme"/></label>
        </section>
