...
(/** @lends <global> */function( $ ) {
	 ...
	 *  @param {object} oSettings dataTables settings object
	 *  @returns {node} Page feature node
	 *  @memberof DataTable#oApi
	 */
	...
	DataTable.defaults = {
		...
		"oLanguage": {
			...
			/**
			 * Page string used by DataTables for the built-in pagination
			 * control types.
			 *  @namespace
	...
	DataTable.models.oSettings = {
		...
		"oFeatures": {
			...
			/**
			 * Page enabled or not. Note that if this is disabled then length
	...
	DataTable.ext = _ext = {
		 ...
		 *
		 * Page types (the four built in options and any additional plug-in
