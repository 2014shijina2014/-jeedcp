...
<div class="wrapper wrapper-content">
    <div class="ibox">
        <div class="ibox-title">
            <h5>表单列表 </h5>（欢迎使用代码生成器，最新版请访问<a target="_blank"
                                              href="http://www.bjxiaowen.com">http://www.bjxiaowen.com</a>)
                ...
                <div class="col-sm-12">
                    <div class="pull-left">
                        <shiro:hasPermission name="gen:genTable:add">
                            <table:addRow url="${ctx}/gen/genTable/form" title="表单" width="1000px"
                                          height="700px"></table:addRow><!-- 增加按钮 -->
                        </shiro:hasPermission>
                        <shiro:hasPermission name="gen:genTable:importDb">
                            <button class="btn btn-white btn-sm " data-toggle="tooltip" data-placement="left" title="导入"
                        ...
                        <shiro:hasPermission name="gen:genTable:edit">
                            <table:editRow url="${ctx}/gen/genTable/form" title="表单" id="contentTable" width="1000px"
                                           height="700px"></table:editRow><!-- 编辑按钮 -->
                        </shiro:hasPermission>
                        <shiro:hasPermission name="gen:genTable:del">
                            <table:delRow url="${ctx}/gen/genTable/deleteAll" id="contentTable"
                                          label="移除记录"></table:delRow><!-- 删除按钮 -->
                        </shiro:hasPermission>
                        <shiro:hasPermission name="gen:genTable:genCode">
                            <button class="btn btn-white btn-sm " data-toggle="tooltip" data-placement="left"
                                    title="生成代码" onclick="genCode()"><i class="fa fa-folder-open-o"></i> 生成代码
                            </button>
                        </shiro:hasPermission>
                ...
                <c:forEach items="${page.list}" var="genTable">
                    <tr>
                        ...
                        <td>
                            <shiro:hasPermission name="gen:genTable:edit">
                                <a href="#"
                                   onclick="openDialog('修改业务表', '${ctx}/gen/genTable/form?id=${genTable.id}','1000px', '700px')"
