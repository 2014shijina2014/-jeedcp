...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/weixin/weixinMessage/">微信推送信息列表</a></li>
		<li class="active"><a href="${ctx}/weixin/weixinMessage/form?id=${weixinMessage.id}">微信推送信息<shiro:hasPermission name="weixin:weixinMessage:edit">${not empty weixinMessage.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="weixin:weixinMessage:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="weixinMessage" action="${ctx}/weixin/weixinMessage/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="showpic" htmlEscape="false" maxlength="255" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="form-actions">
			<shiro:hasPermission name="weixin:weixinMessage:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
