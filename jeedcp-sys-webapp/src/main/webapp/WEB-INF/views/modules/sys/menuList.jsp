                ...
                <shiro:hasPermission name="sys:menu:edit">
                    <td nowrap>
                        ...
                        <a href="${ctx}/sys/menu/delete?id=${menu.id}"
                           onclick="return confirmx('要删除该菜单及所有子菜单项吗？', this.href)"class="btn btn-danger btn-xs"><i class="fa fa-trash"></i>删除</a>
                        <a href="${ctx}/sys/menu/form?parent.id=${menu.id}" class="btn btn-info btn-xs"><i class="fa fa-add"></i>添加下级菜单</a>
                    </td>
                </shiro:hasPermission>
            </tr>
        </c:forEach></tbody>
