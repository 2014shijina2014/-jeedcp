...
<form:form id="inputForm" modelAttribute="role"
    ...
    <div class="form-group">
        <label class="control-label">角色名称:<span class="help-inline"><font color="red">*</font> </span></label>
        <div class="controls">
            <input id="oldName" name="oldName" type="hidden" value="${role.name}">
            <form:input path="name" htmlEscape="false" class="required form-control"/>
        </div>
    </div>
    <div class="form-group">
        <label class="control-label">英文名称:<span class="help-inline"><font color="red">*</font> 工作流用户组标识</span></label>
        <div class="controls">
            <input id="oldEnname" name="oldEnname" type="hidden" value="${role.enname}">
            <form:input path="enname" htmlEscape="false" class="required  form-control"/>
        </div>
    </div>
    <div class="form-group">
