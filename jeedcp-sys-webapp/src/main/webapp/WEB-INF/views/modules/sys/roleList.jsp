...
<table id="contentTable" class="table table-hover">
    ...
    <c:forEach items="${list}" var="role">
        <tr>
            ...
            <shiro:hasPermission name="sys:role:edit">
                <td>
                    <a href="${ctx}/sys/role/assign?id=${role.id}" class="btn btn-info btn-xs"><i class="fa fa-add"></i>分配</a>
                    ...
                    <a href="${ctx}/sys/role/delete?id=${role.id}"
                       onclick="return confirmx('确认要删除该角色吗？', this.href)" class="btn btn-danger btn-xs"><i class="fa fa-trash"></i>删除</a>
                </td>
            </shiro:hasPermission>
        </tr>
    </c:forEach>
