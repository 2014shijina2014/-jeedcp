...
import com.jeedcp.modules.sys.service.DictService;
...
public class DictController extends BaseController {
	...
	public String delete(Dict dict, HttpServletRequest request, RedirectAttributes redirectAttributes) {
		if(Global.isDemoMode()){
			addMessage(redirectAttributes, "演示模式，不允许操作！");
		...
		return "redirect:" + adminPath + "/sys/dict/?type="+dict.getType()+"&pageNum="+no;
	}
