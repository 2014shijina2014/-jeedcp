...
import com.jeedcp.modules.sys.exceldto.UserExcel;
import com.jeedcp.modules.sys.service.SystemService;

import com.jeedcp.modules.sys.utils.CurrentUserUtils;
import com.jeedcp.modules.sys.utils.ExportExcel;
import com.jeedcp.modules.sys.utils.ImportExcel;
...
public class UserController extends BaseController {
	...
	public String form(User user, Model model) {
		if (user.getCompany()==null || user.getCompany().getId()==null){
			user.setCompany(CurrentUserUtils.getUser().getCompany());
		}
		if (user.getOffice()==null || user.getOffice().getId()==null){
			user.setOffice(CurrentUserUtils.getUser().getOffice());
		}
	...
	public String save(User user, HttpServletRequest request, Model model, RedirectAttributes redirectAttributes) {
		...
		// 清除当前用户缓存
//		if (user.getLoginName().equals(CurrentUserUtils.getUser().getLoginName())){
...
//		}
	...
	public String delete(User user, HttpServletRequest request,RedirectAttributes redirectAttributes) {
		...
		if (CurrentUserUtils.getUser().getId().equals(user.getId())){
		...
		return "redirect:" + adminPath + "/sys/user/list?office.id="+user.getOffice().getId()+"&pageNum="+no;
	}
    ...
    public String importFileTemplate(HttpServletResponse response, RedirectAttributes redirectAttributes) {
		try {
    		...
    		List<User> list = Lists.newArrayList(); list.add(CurrentUserUtils.getUser());
	...
	public User infoData() {
		return CurrentUserUtils.getUser();
	}
