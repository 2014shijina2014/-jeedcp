...
import com.jeedcp.modules.sys.service.AreaService;
...
public class AreaController extends BaseController {
	...
	public String form(Area area, Model model) {
		if (area.getParent()==null||area.getParent().getId()==null){
			area.setParent(CurrentUserUtils.getUser().getOffice().getArea());
		}
...
//		}
		...
		return "redirect:" + adminPath + "/sys/area/"+"?pageNum="+no;
	}
