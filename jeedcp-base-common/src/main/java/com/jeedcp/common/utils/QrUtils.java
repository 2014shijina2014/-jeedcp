...
public class QrUtils {
	...
	public static void main(String[] args) {
		...
		QrUtils.encode(contents, width, height, imgPath);
		System.out.println("finished zxing EAN-13 encode.");

		String decodeContent = QrUtils.decode(imgPath);
		...
		QrUtils.encode2(contents2, width2, height2, imgPath2);
		System.out.println("finished zxing encode.");

		String decodeContent2 = QrUtils.decode2(imgPath2);
