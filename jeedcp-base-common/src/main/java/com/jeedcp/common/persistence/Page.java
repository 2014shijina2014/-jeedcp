...
public class Page<T> {
    ...
    public String toString() {
        ...
        if (pageNo == first) {// 如果是首页
            sb.append("<li class=\"disabled\"><a style=\"margin-left: 5px;\" href=\"javascript:\">&#171; 上一页</a></li>\n");
        } else {
            sb.append("<li><a  style=\"margin-left: 5px;\" href=\"javascript:\" onclick=\"" + funcName + "(" + prev + "," + pageSize + ",'" + funcParam + "');\">&#171; 上一页</a></li>\n");
        }
