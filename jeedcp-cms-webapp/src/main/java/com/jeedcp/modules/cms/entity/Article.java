 ...
 */
package com.jeedcp.modules.cms.entity;
...
import com.jeedcp.modules.cms.utils.CmsUrlUtils;
...
public class Article extends DataEntity<Article> {
	...
	// todo cmsutil 高度耦合，split to CmsUrlUtils
	public String getUrl() {
		return CmsUrlUtils.getUrlDynamic(this);
	}

	public String getImageSrc() {
		return CmsUrlUtils.formatImageSrcToWeb(this.image);
	}
