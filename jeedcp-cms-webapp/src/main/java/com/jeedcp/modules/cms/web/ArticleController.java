...
import com.jeedcp.modules.cms.service.*;
import com.jeedcp.modules.cms.utils.CmsUtils;
import com.jeedcp.modules.cms.utils.TplUtils;
...
//		}
	...
	public String save(Article article, Model model, RedirectAttributes redirectAttributes) {
		...
		return "redirect:" + adminPath + "/cms/article/?category.id="+(categoryId!=null?categoryId:"");
	}
	
	@RequiresPermissions("cms:article:edit")
	@RequestMapping(value = "delete")
	public String delete(Article article, HttpServletRequest request, String categoryId, @RequestParam(required=false) Boolean isRe, RedirectAttributes redirectAttributes) {
		// 如果没有审核权限，则不允许删除或发布。
		if (!CurrentUserUtils.getSubject().isPermitted("cms:article:audit")){
		...
		return "redirect:" + adminPath + "/cms/article/?category.id="+(categoryId!=null?categoryId:"")+"&pageNum="+no;
	}
