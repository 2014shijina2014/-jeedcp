...
import com.jeedcp.modules.cms.service.FileTplService;
...
public class CategoryController extends BaseController {
	...
	public String delete(Category category, HttpServletRequest request,RedirectAttributes redirectAttributes) {
		if(Global.isDemoMode()){
			addMessage(redirectAttributes, "演示模式，不允许操作！");
			return "redirect:" + adminPath + "/cms/category/";
		}
