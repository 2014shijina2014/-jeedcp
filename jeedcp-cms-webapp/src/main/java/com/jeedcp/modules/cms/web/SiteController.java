...
import com.jeedcp.common.utils.CookieUtils;
...
public class SiteController extends BaseController {
	...
	public String save(Site site, Model model, RedirectAttributes redirectAttributes) {
		if(Global.isDemoMode()){
			...
			return "redirect:" + adminPath + "/cms/site/";
		}
	...
	public String delete(Site site, HttpServletRequest request,@RequestParam(required=false) Boolean isRe, RedirectAttributes redirectAttributes) {
		if(Global.isDemoMode()){
			addMessage(redirectAttributes, "演示模式，不允许操作！");
			return "redirect:" + adminPath + "/cms/site/";
		}
		...
		return "redirect:" + adminPath + "/cms/site/?pageNum="+no;
	}
