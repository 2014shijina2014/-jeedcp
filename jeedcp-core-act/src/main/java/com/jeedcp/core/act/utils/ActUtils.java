 ...
 */
package com.jeedcp.core.act.utils;
...
import com.jeedcp.common.annotation.FieldName;
...
import com.jeedcp.util.ObjectUtils;
...
//	}
	...
	/**
	 * adapted user entity for activiti node.
	 * 
	 * @param userList
	 * @return

	 */
	public static List<com.jeedcp.entity.user.UserEntity> toActivitiNodeUser(
			List<User> userList) {
		List<com.jeedcp.entity.user.UserEntity> list = new ArrayList<com.jeedcp.entity.user.UserEntity>();
		...
		for (int i = 0; i < userList.size(); i++) {
			...
			com.jeedcp.entity.user.UserEntity userEntity = new com.jeedcp.entity.user.UserEntity();
			userEntity.setId(user.getLoginName());
			userEntity.setName(user.getName());
			userEntity.setEmail(user.getEmail());
			userEntity.setMobile(user.getMobile());
			userEntity.setNo(user.getNo());
			userEntity.setCompanyId(user.getCompany() == null ? null : user
					.getCompany().getId());
			userEntity.setCompanyName(user.getCompany() == null ? null : user
					.getCompany().getName());
			userEntity.setOfficeId(user.getOffice() == null ? null : user
					.getOffice().getId());
			userEntity.setOfficeName(user.getOffice() == null ? null : user
					.getOffice().getName());
			list.add(userEntity);
		}
		return list;
