...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/weixin/weixinMenu/">微信菜单列表</a></li>
		<shiro:hasPermission name="weixin:weixinMenu:edit"><li><a href="${ctx}/weixin/weixinMenu/form">微信菜单添加</a></li></shiro:hasPermission>
	</ul>
	<form:form id="searchForm" modelAttribute="weixinMenu" action="${ctx}/weixin/weixinMenu/" method="post" class="breadcrumb form-search">
		<ul class="ul-form">
			...
			<li><label>排序：</label>
				<form:input path="sort" htmlEscape="false" maxlength="255" class="input-medium"/>
			</li>
			<li><label>所属组：</label>
	...
	<script type="text/template" id="treeTableTpl">
		<tr id="{{row.id}}" pId="{{pid}}">
			...
			<shiro:hasPermission name="weixin:weixinMenu:edit"><td>
				...
				<a href="${ctx}/weixin/weixinMenu/delete?id={{row.id}}" onclick="return confirmx('确认要删除该微信菜单及所有子微信菜单吗？', this.href)">删除</a>
				<a href="${ctx}/weixin/weixinMenu/form?parent.id={{row.id}}">添加下级微信菜单</a> 
