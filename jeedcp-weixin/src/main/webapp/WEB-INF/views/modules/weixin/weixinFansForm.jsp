...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${ctx}/weixin/weixinFans/form?id=${weixinFans.id}">微信粉丝<shiro:hasPermission name="weixin:weixinFans:edit">${not empty weixinFans.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="weixin:weixinFans:edit">查看</shiro:lacksPermission></a></li>
		<shiro:hasPermission name="weixin:weixinFans:edit"><li><a href="${ctx}/weixin/weixinFans/toSync">微信粉丝同步</a></li></shiro:hasPermission>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="weixinFans" action="${ctx}/weixin/weixinFans/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="subscribetime" htmlEscape="false" maxlength="255" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="gender" htmlEscape="false" maxlength="4" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="headimgurl" htmlEscape="false" maxlength="1000" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">微信ID：</label>
			<div class="controls">
				<form:input path="wxid" htmlEscape="false" maxlength="255" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="form-actions">
			<shiro:hasPermission name="weixin:weixinFans:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
