...
<body class="gray-bg">
   <div class="row  border-bottom white-bg dashboard-header">
    ...
    JeePlus快速开发宗旨是：简单功能由代码生成器生成使用; 复杂业务采用表单自定义，业务流程使用工作流来实现、扩展出任务接口，供开发编写业务逻辑。 实现了流程任务节点和任务接口的灵活配置，既保证了公司流程的保密性，又减少了开发人员的工作量
    			<br/>
               <br>JeePlus采用了目前极为流行的扁平化响应式的设计风格，可以完美的兼容电脑，pad，手机等多个平台。前端UI采用了<a target="_blank" href="http://wrapbootstrap.com/preview/WB0R5L90S">INSPINIA</a>(点击访问）为原型开发，Jeedcp v2.0发布时作者将bootstrap升级到了最新的3.3.4。
                <br>…………
            </blockquote>
                            	...
                            	<div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h5 class="panel-title">
                                                <a data-toggle="collapse" data-parent="#version" href="#v2.4">v2.4</a><code class="pull-right"></code>
                                            </h5>
                                    </div>
                ...
                <div class="ibox float-e-margins">
                  ...
                  <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        ...
                        <%--<p><i class="fa fa-credit-card"></i> 支付宝：<a href="javascript:;" class="支付宝信息">wangleiyahoo@gmail.com</a>--%>
                        <%--</p>--%>
                    </div>
                </div>
            </div>
