...
<body class="fixed-sidebar full-height-layout gray-bg">
    <div id="wrapper">
                ...
                <ul class="nav" id="side-menu">
                    <li class="nav-header">
                        <div class="dropdown profile-element">
                            <span><img alt="image" class="img-circle" style="height:64px;width:64px;" src="https://ss0.bdstatic.com/94oJfD_bAAcT8t7mm9GUKT-xh_/timg?image&quality=100&size=b4000_4000&sec=1473905467&di=71c263c442f8ca175ff5710bd9df7c3a&src=http://dynamic-image.yesky.com/300x-/uploadImages/upload/20140909/upload/201409/1ztwwiq5wrcjpg.jpg" /></span>
        ...
        <div id="page-wrapper" class="gray-bg dashbard-1">
            ...
            <div class="footer">
                <div class="pull-left"><a href="http://www.jeedcp.org">http://www.jeedcp.org</a> &copy; 2015-2025</div>
            </div>
        </div>
        <!--右侧部分结束-->
