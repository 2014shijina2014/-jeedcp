...
<head>
    ...
    <script type="text/javascript">
        ...
        function createMenu(){
            ...
            openDialog('创建菜单','/jeedcp/a/gen/genScheme/menuForm?gen_table_id='+id,'800px', '500px');
        }
        function page(n,s){
            if(n) $("#pageNo").val(n);
            if(s) $("#pageSize").val(s);
...
<div class="wrapper wrapper-content">
    <div class="ibox">
        <div class="ibox-title">
            <h5>表单列表  </h5>（欢迎使用代码生成器，最新版请访问<a target="_blank" href="http://www.jeedcp.org">http://www.jeedcp.org</a>)
